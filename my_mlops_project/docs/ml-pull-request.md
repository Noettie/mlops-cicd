...
* [Staging workspace registered model](https://adb-2396132839216422.2.azuredatabricks.net/ml/models/staging-my_mlops_project-model)
* [Prod workspace registered model](https://adb-6507536166628980.0.azuredatabricks.net/ml/models/prod-my_mlops_project-model). 
